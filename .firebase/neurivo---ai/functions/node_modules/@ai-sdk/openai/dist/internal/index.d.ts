...
declare const openaiImageModelOptions: _ai_sdk_provider_utils.LazySchema<{
    quality?: "low" | "medium" | "high" | "xhigh" | "max" | "auto" | "standard" | "hd" | undefined;
 ...
 */
type OpenAIResponsesAllowedTool = {
    type: 'function';
    name: string;
} | {
    type: 'custom';
    ...
    type: Exclude<OpenAIResponsesTool['type'], 'function' | 'custom' | 'mcp' | 'namespace' | 'tool_search'>;
};
...
declare const openaiResponsesSupportedUrls: Record<string, RegExp[]>;
declare class OpenAIResponsesLanguageModel implements LanguageModelV4 {
    ...
    readonly supportedUrls: Record<string, RegExp[]>;
    get provider(): string;
    static prepareRequest({ modelId, config, options: { maxOutputTokens, temperature, stopSequences, topP, topK, presencePenalty, frequencyPenalty, seed, prompt, reasoning, providerOptions, tools, toolChoice, responseFormat, }, }: {
...
type ResponsesToolCallProviderMetadata = {
    itemId: string;
    async?: boolean;
    namespace?: string;
    caller?: {
...
type OpenaiResponsesToolCallProviderMetadata = {
...
declare const imageGenerationArgsSchema: _ai_sdk_provider_utils.LazySchema<{
    ...
    quality?: "low" | "medium" | "high" | "xhigh" | "max" | "auto" | undefined;
