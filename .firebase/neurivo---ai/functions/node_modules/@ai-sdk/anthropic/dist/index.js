...
var anthropicStopDetailsSchema = z3.object({
  type: z3.string(),
    ...
    z3.object({
      ...
      usage: z3.looseObject({
        ...
        iterations: z3.array(
          z3.object({
            type: z3.union([
              z3.literal("compaction"),
              z3.literal("message"),
              z3.literal("advisor_message"),
              z3.literal("fallback_message")
            ]),
            model: z3.string().nullish(),
            input_tokens: z3.number(),
            output_tokens: z3.number(),
...
var anthropicFilePartProviderOptions = z4.object({
   ...
   */
  containerUpload: z4.boolean().optional(),
  /**
...
var advisor_20260301ArgsSchema = lazySchema4(
  () => zodSchema4(
    z5.object({
      model: z5.string(),
...
var advisor_20260301OutputSchema = lazySchema4(
  () => zodSchema4(
...
var advisor_20260301InputSchema = lazySchema4(
  () => zodSchema4(z5.object({}).strict())
);
var factory = createProviderExecutedToolFactory({
...
var textEditor_20250728ArgsSchema = lazySchema5(
  () => zodSchema5(
    z6.object({
      maxCharacters: z6.number().optional()
    })
  )
);
var textEditor_20250728InputSchema = lazySchema5(
  () => zodSchema5(
    z6.object({
      command: z6.enum(["view", "create", "str_replace", "insert"]),
      path: z6.string(),
      file_text: z6.string().optional(),
      insert_line: z6.number().int().optional(),
      new_str: z6.string().optional(),
      insert_text: z6.string().optional(),
      old_str: z6.string().optional(),
      view_range: z6.array(z6.number().int()).optional()
    })
  )
);
...
var webSearch_20260209ArgsSchema = lazySchema6(
  () => zodSchema6(
    z7.object({
...
var webSearch_20260209OutputSchema = lazySchema6(
  () => zodSchema6(
    z7.array(
      z7.object({
        url: z7.string(),
...
var webSearch_20260209InputSchema = lazySchema6(
  () => zodSchema6(
    z7.object({
      query: z7.string()
    })
...
var webSearch_20250305OutputSchema = lazySchema7(
  () => zodSchema7(
    z8.array(
      z8.object({
        url: z8.string(),
        title: z8.string().nullable(),
        pageAge: z8.string().nullable(),
        encryptedContent: z8.string(),
        type: z8.literal("web_search_result")
      })
    )
  )
);
var webSearch_20250305InputSchema = lazySchema7(
  () => zodSchema7(
    z8.object({
      query: z8.string()
    })
...
var webFetch_20260209ArgsSchema = lazySchema8(
  () => zodSchema8(
    z9.object({
...
var webFetch_20260209OutputSchema = lazySchema8(
  () => zodSchema8(
    z9.object({
...
var webFetch_20260209InputSchema = lazySchema8(
  () => zodSchema8(
    z9.object({
      url: z9.string()
    })
...
var webFetch_20250910ArgsSchema = lazySchema9(
  () => zodSchema9(
    z10.object({
      maxUses: z10.number().optional(),
      allowedDomains: z10.array(z10.string()).optional(),
      blockedDomains: z10.array(z10.string()).optional(),
      citations: z10.object({ enabled: z10.boolean() }).optional(),
      maxContentTokens: z10.number().optional()
    })
  )
);
var webFetch_20250910OutputSchema = lazySchema9(
  () => zodSchema9(
    z10.object({
      type: z10.literal("web_fetch_result"),
      url: z10.string(),
      content: z10.object({
        ...
        source: z10.union([
          z10.object({
            ...
            mediaType: z10.literal("application/pdf"),
            data: z10.string()
          }),
          z10.object({
            type: z10.literal("text"),
            mediaType: z10.literal("text/plain"),
            data: z10.string()
          })
        ])
      }),
      retrievedAt: z10.string().nullable()
    })
  )
);
var webFetch_20250910InputSchema = lazySchema9(
  () => zodSchema9(
    z10.object({
      url: z10.string()
    })
...
var codeExecution_20250522OutputSchema = lazySchema10(
  () => zodSchema10(
    z11.object({
...
var codeExecution_20250522InputSchema = lazySchema10(
  () => zodSchema10(
    z11.object({
      code: z11.string()
    })
...
var codeExecution_20250825OutputSchema = lazySchema11(
  () => zodSchema11(
...
var codeExecution_20250825InputSchema = lazySchema11(
  () => zodSchema11(
    z12.discriminatedUnion("type", [
...
var codeExecution_20260120OutputSchema = lazySchema12(
  () => zodSchema12(
    z13.discriminatedUnion("type", [
      z13.object({
        type: z13.literal("code_execution_result"),
        stdout: z13.string(),
        stderr: z13.string(),
        return_code: z13.number(),
        content: z13.array(
          z13.object({
            type: z13.literal("code_execution_output"),
            file_id: z13.string()
          })
        ).optional().default([])
      }),
      z13.object({
        type: z13.literal("encrypted_code_execution_result"),
        encrypted_stdout: z13.string(),
        stderr: z13.string(),
        return_code: z13.number(),
        content: z13.array(
          z13.object({
      ...
      z13.object({
        type: z13.literal("bash_code_execution_result"),
        content: z13.array(
          z13.object({
            type: z13.literal("bash_code_execution_output"),
            file_id: z13.string()
          })
        ),
        stdout: z13.string(),
      ...
      z13.object({
        type: z13.literal("bash_code_execution_tool_result_error"),
        error_code: z13.string()
      }),
      z13.object({
        type: z13.literal("text_editor_code_execution_tool_result_error"),
        error_code: z13.string()
      }),
      z13.object({
        type: z13.literal("text_editor_code_execution_view_result"),
        content: z13.string(),
        file_type: z13.string(),
        num_lines: z13.number().nullable(),
        start_line: z13.number().nullable(),
        total_lines: z13.number().nullable()
      }),
      z13.object({
        type: z13.literal("text_editor_code_execution_create_result"),
        is_file_update: z13.boolean()
      }),
      z13.object({
        type: z13.literal("text_editor_code_execution_str_replace_result"),
        lines: z13.array(z13.string()).nullable(),
        new_lines: z13.number().nullable(),
        new_start: z13.number().nullable(),
        old_lines: z13.number().nullable(),
        old_start: z13.number().nullable()
      })
    ])
  )
);
var codeExecution_20260120InputSchema = lazySchema12(
  () => zodSchema12(
    z13.discriminatedUnion("type", [
      z13.object({
        type: z13.literal("programmatic-tool-call"),
        code: z13.string()
      }),
      z13.object({
        type: z13.literal("bash_code_execution"),
        command: z13.string()
      }),
      z13.discriminatedUnion("command", [
        z13.object({
          type: z13.literal("text_editor_code_execution"),
...
var toolSearchRegex_20251119OutputSchema = lazySchema13(
  () => zodSchema13(
    z14.array(
      z14.object({
        type: z14.literal("tool_reference"),
        toolName: z14.string()
      })
    )
  )
);
var toolSearchRegex_20251119InputSchema = lazySchema13(
  () => zodSchema13(
    z14.object({
      /**
...
var textEditor_20250124InputSchema = lazySchema22(
  () => zodSchema22(
    z23.object({
      ...
      new_str: z23.string().optional(),
      insert_text: z23.string().optional(),
      old_str: z23.string().optional(),
      view_range: z23.array(z23.number().int()).optional()
    })
  )
);
...
var factory11 = createProviderExecutedToolFactory10({
