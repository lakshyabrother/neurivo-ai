...
var baseImageModelOptionsObject = z9.object({
   ...
   */
  quality: z9.enum(["standard", "hd", "low", "medium", "high", "xhigh", "max", "auto"]).optional(),
  /**
...
var imageGenerationArgsSchema = lazySchema22(
  () => zodSchema22(
    z24.object({
      ...
      quality: z24.enum(["auto", "low", "medium", "high", "xhigh", "max"]).optional(),
      size: z24.union([
